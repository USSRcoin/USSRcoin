...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 111 * COIN;

            if(nBestHeight == 0)
            {
            nSubsidy = 108780000 * COIN;
            }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1511862049, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "USSRcoin";
        CTransaction txNew;
        txNew.nTime = 1511862049;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1511862049;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 537969 : 537969;
        ...
        assert(block.hashMerkleRoot == uint256("0xdee5bd48c6de34e04047a577a6380cbbca9132c7d30ba4a4b92375f9c3f7e463"));
...
unsigned char pchMessageStart[4] = { 0xe5, 0x5a, 0xbd, 0x1d };
